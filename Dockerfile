...
RUN buildDeps='make build-essential g++ gcc' \
 ...
 && mkdir -p /mnt/shared/lib/python2 && /usr/bin/python2 -m virtualenv --python /usr/bin/python2 /mnt/shared/lib/python2 && cd /mnt/shared/lib/python2/ && source bin/activate && pip install --upgrade jedi pylint pylint-flask pylint-django && deactivate && chown -R ${UID}:${GID} /mnt/shared/lib/python2 \
 && pip3 install -r /tmp/requirements.txt \
 && mkdir -p /mnt/shared/lib/python3 && /usr/bin/python3 -m virtualenv --python /usr/bin/python3 /mnt/shared/lib/python3 && /mnt/shared/lib/python3/ && source bin/activate && pip install --upgrade jedi pylint pylint-flask pylint-django && deactivate && chown -R ${UID}:${GID} /mnt/shared/lib/python3 \
